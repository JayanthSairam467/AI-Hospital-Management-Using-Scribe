              ...
              <div className="flex items-center space-x-2.5 pl-2 border-l border-slate-200">
                ...
                >
                  ...
                  <div className="hidden xl:block">
                    ...
                    <p className="text-[10px] text-slate-500">Internal Medicine & Card.</p>
                  </div>
                </button>
                ...
                <button
                  ...
                  onClick={() => handleNavigate("landing")}
                  className="p-1.5 text-slate-400 hover:text-slate-700 hover:bg-slate-100 rounded-md transition-colors text-xs"
                  title="Switch to Landing Page / Pitch"
                >
