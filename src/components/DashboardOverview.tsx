      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      ...
                      <div className="text-right">
                        <span
                          className={`font-mono font-bold ${
                            isCritical ? "text-red-700" : isLow ? "text-amber-700" : "text-slate-800"
                          }`}
                        >
                    ...
                    .map((bed) => {
                      ...
                      return (
                        <div
                          ...
                          title={`${bed.code} - ${bed.status.toUpperCase()} ${
                        ...
                        >
                          ...
                          <div className="text-[10px] font-medium truncate">
                            {bed.patientName ? bed.patientName.split(" ")[0] : "Vacant"}
                          </div>
                          {bed.spO2 && (
                  ...
                  <div key={idx} className="space-y-1 text-xs">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-1.5">
                        <span
                          className={`font-mono font-bold ${
                            isCritical ? "text-red-600 animate-pulse" : isWarning ? "text-amber-600" : "text-emerald-600"
                          }`}
                        >
                          {ox.currentLevelPct}%
                        </span>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-2xs flex flex-col justify-between space-y-4">
          <div className="space-y-1">
            ...
            <div className="pt-2">
              <div className="relative h-28 w-full bg-slate-900 rounded-xl overflow-hidden border border-slate-800 flex items-center justify-center">
                {/* SVG Route grid placeholder */}
                ...
                <svg className="absolute inset-0 w-full h-full">
                  <path
                    d="M 20 80 Q 90 20, 160 50 T 260 30"
                    fill="none"
                    stroke="#ef4444"
                    strokeWidth="3"
                    strokeDasharray="4 2"
                ...
                <div className="absolute top-6 right-16 flex items-center space-x-1.5 bg-red-600 text-white px-2 py-0.5 rounded-md text-[10px] font-bold shadow-lg animate-bounce">
                  <AmbulanceIcon className="w-3 h-3" />
                  <span>Ambulance 1</span>
                </div>

                <div className="absolute bottom-2 left-3 bg-slate-800/90 backdrop-blur-xs text-white text-[10px] px-2 py-0.5 rounded border border-slate-700">
                  Hospital Trauma Bay 1
                </div>
              </div>
            </div>
